...
var ErrorListener = /*#__PURE__*/function (_antlr4$error$ErrorLi) {
  ...
  _createClass(ErrorListener, [{
    ...
    value: function isLexer(recogniser) {
      return recogniser instanceof _T6TriggerLexer.default;
    }
  }, {
    key: "syntaxError",
    value: function syntaxError(recognizer, offendingSymbol, line, column, msg, e) {
      var source = this.isLexer(recognizer) ? _types.ESource.LEXER : _types.ESource.PARSER;
      this.report = new _CoLangError.CoLangError({
        message: msg,
        source: source,
        line: line,
        column: column,
